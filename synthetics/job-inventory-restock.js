...
const end = new Date(start.getTime() + getRandomMinutes(120,240)*60000);

const payload = [
  	{
		"eventType": "Jobs",
		"account": ACCOUNT.id,
		"jobName": "Inventory - Restock",
		"jobId": $env.JOB_ID,
		"startTimestamp": start.getMilliseconds()
	},
	{
		"eventType": "Jobs",
		"account": ACCOUNT.id,
		"jobName": "Inventory - Restock",
		"jobId": $env.JOB_ID,
		"endTimestamp": end.getMilliseconds()
	},
]
